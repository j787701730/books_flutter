...
class Css3 extends StatefulWidget {
  final props;

  Css3(this.props);

  @override
  _Css3State createState() => _Css3State();
}

class _Css3State extends State<Css3> {
  @override
  void initState() {
  ...
  _getMenu() async {
    Response response =
        await Dio().get("https://waylau.gitbooks.io/css3-tutorial/content/search_index.json");
    if (mounted) {
      setState(() {
  ...
  _getContent() async {
    ...
    Response response =
        await Dio().get("https://waylau.gitbooks.io/css3-tutorial/content/$current");
    if (mounted) {
      setState(() {
      ...
      body: content.isEmpty
          ...
          : ListView(
              ...
              children: <Widget>[
                Html(
                  data: '$content'
                      .substring(content.indexOf('<section'), content.indexOf('</section>')).replaceAll('src="../', 'src="https://waylau.gitbooks.io/css3-tutorial/content/'),
